...
class WheeledBaseRobot(BaseRobot):
    """轮式机器人公共基类：骨架方法（初始化/观测/动作），子类负责创建 articulation"""
...
class JetbotRobot(WheeledBaseRobot):
